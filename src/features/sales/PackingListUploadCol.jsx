...
/**
 * Packing List column that triggers simulated uploads and handles
 * visual presentation and delete confirmations for Packing List entires.
 */
export default function PackingListUploadCol({
  packingList = [],
  onUploadPacking,
  pendingDelete,
  onInitiateDelete,
